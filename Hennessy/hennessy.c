...
/* Hans Klaver, March 2020: 
    - adapted from stanford.c 
      ( https://classes.engineering.wustl.edu/cse465/docs/BCCExamples/stanford.c )
    - added 'runs', 
    - changed Getclock to return milliseconds
...
float value;
float fixed, floated, fl; 
float pFixed, pFixfloated, pFloated;
int   m, total;
...
*/
long long Getclock (void)  // uses sys/time.h
...
/* rewrite (output); */
    ...
    pFixed = pFixed * xtimes[1];   
    pFixfloated = pFixfloated * xtimes[1];   
    total = total + xtimes[1];
    ...
    pFixed = pFixed * xtimes[2];   
    pFixfloated = pFixfloated * xtimes[2];   
    total = total + xtimes[2];
    ...
    pFixed = pFixed * xtimes[3];   
    pFixfloated = pFixfloated * xtimes[3];   
    total = total + xtimes[3];
    ...
    pFixed = pFixed * xtimes[4];   
    pFixfloated = pFixfloated * xtimes[4];   
    total = total + xtimes[4];
    ...
    fl = fl + fpmmbase * xtimes[5];
    pFloated = pFloated * xtimes[5];   
    pFixfloated = pFixfloated * xtimes[5];   
    total = total + xtimes[5];
    ...
    pFixed = pFixed * xtimes[6];   
    pFixfloated = pFixfloated * xtimes[6];   
    total = total + xtimes[6];
    ...
    pFixed = pFixed * xtimes[7];   
    pFixfloated = pFixfloated * xtimes[7];   
    total = total + xtimes[7];
    ...
    pFixed = pFixed * xtimes[8];   
    pFixfloated = pFixfloated * xtimes[8];   
    total = total + xtimes[8];
    ...
    pFixed = pFixed * xtimes[9];   
    pFixfloated = pFixfloated * xtimes[9];   
    total = total + xtimes[9];
    ...
    fl = fl + fpfftbase * xtimes[10];
    pFloated = pFloated * xtimes[10];   
    pFixfloated = pFixfloated * xtimes[10];   
    total = total + xtimes[10];
    ...
    /* compute composites */
    printf ("\n");
    printf ("Nonfloating point composite is %5.0f ms\n", fixed / 10.0);
    printf ("Floating point composite is    %5.0f ms\n", floated / 10.0);
    printf ("\n");

    /* compute composites the right way */
    printf ("\n");
    printf ("Nonfloating point composite         %5.0f ms\n", fixed / 8.0);
    printf ("Floating point composite            %5.0f ms\n", floated / 10.0);
    printf ("\n");

    /* compute weighted arithmetic means */    
    printf ("* Weighted arithmetic means *: \n");
    m = floor(fixed/8.0 + 0.5);
    printf ("Nonfloating-point composite         %5d ms\n", m);
    m = floor(floated/10.0 + 0.5);
    printf ("Fl.-point + nonfl.-point composite  %5d ms\n", m);
    m = floor(fl/2.0 + 0.5);
    printf ("Floating-point composite (Mm & FFT) %5d ms\n", m);
    printf ("\n");

    /* compute geometric means */    
    printf ("* Geometric means *: \n");
    m = floor(pow(pFixed, 0.125) + 0.5);     // = 8th root
    printf ("Nonfloating-point                   %5d ms\n", m);
    m = floor(pow(pFixfloated, 0.1) + 0.5);  // = 10th root
    printf ("Floating-point + nonfloating-point  %5d ms\n", m);
    m = floor(pow(pFloated, 0.5) + 0.5);     // = 2nd root (sqrt)
    printf ("Floating-point (Mm & FFT)           %5d ms\n", m);
